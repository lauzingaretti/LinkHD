#'@title OTU2Taxa
#'@description This function aggregates OTUs into their taxonomic characteristics,i.e.
...
#'@param AnalysisLev It is a character indicating if data should be aggregate into genera
#' or family level
#'@export OTU2Taxa
#'@return List. The function outputs a list of size two. The first element  contains all the selected taxa with
